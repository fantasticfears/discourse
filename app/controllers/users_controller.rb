...
class UsersController < ApplicationController
  ...
  skip_before_filter :check_xhr, only: [:show, :password_reset, :email_login, :update, :account_created, :activate_account, :perform_account_activation, :user_preferences_redirect, :avatar, :my_redirect, :toggle_anon, :admin_login, :confirm_admin]
